...
export function MentalMath({onBack,onFinish}){
  ...
  const wrap=ch=>(<div style={{minHeight:"100dvh",background:C.bg,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Segoe UI',sans-serif",color:C.text,padding:20}}><div style={{maxWidth:480,width:"100%",textAlign:"center"}}>{ch}</div></div>);
  ...
  if(screen==="playing"&&question)return(
    <div style={{minHeight:"100dvh",background:C.bg,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"'Segoe UI',sans-serif",color:C.text,padding:20,gap:20}}>
